...
class PacksControllerTest < ActionController::TestCase
  ...
  test "should create pack" do
    assert_difference('Pack.count') do
      post :create, pack: { description: @pack.description, offer: @pack.offer, price: @pack.price, tag: @pack.tag, validity: @pack.validity }
    end
  ...
  test "should update pack" do
    patch :update, id: @pack, pack: { description: @pack.description, offer: @pack.offer, price: @pack.price, tag: @pack.tag, validity: @pack.validity }
    assert_redirected_to pack_path(assigns(:pack))
  end
